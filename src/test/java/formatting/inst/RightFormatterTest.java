...
public class RightFormatterTest {
	Formatter formater = FormatterFactory.build(Right.ID);
	@Test
	public void testProcess() {
		List<String> lines = formater.process("This text should be right aligned", 10);
		assertTrue("Expected lines.",lines.size()==4);
		String[] o = {" This text"," should be","     right","   aligned"};
		assertArrayEquals("Validate each line.",o, lines.toArray());
	}

	@Test
	public void testProcess2() {
		List<String> lines = formater.process("This text should be right aligned", 20);
